// home-questions.js — question type toggle + inline create + search focus
...
(function () {
    ...
    // Wire type select — replaces onchange="toggleQOptions(this.value)"
    if (type) type.addEventListener('change', function () { toggleQOptions(type.value); });

-- Migration 027: Restyle standardwelcometext for programid 1056
-- Rewrites content into .welcome-section div cards with h3 headings,
-- matching the dark-theme bevel-box fieldset aesthetic used across the site.
-- Applies to programid 1056 (Australian Event Awards 2026) only.

UPDATE Program
SET standardwelcometext = N'<div class="welcome-section">
<h3>Welcome</h3>
...
<p>If you upload a video, please also send a high-resolution copy by <strong>23 July 2026</strong> via Dropbox or similar to <a href="mailto:enquiries@eventawards.com.au">enquiries@eventawards.com.au</a> (Entry Number must be the filename), or post on USB to:</p>
<p>Australian Event Awards &mdash; c/- The Epic Team Pty Ltd, Suite 1A1, 410 Elizabeth St, Surry Hills NSW 2010</p>

// routes/reportPaidNotFinalised.js
// GET /:slug/reportPaidNotFinalised
// Downloads an Excel report of entries that are paid but not yet finalised.

import { Router } from 'express';
import ExcelJS from 'exceljs';
import { requireAuth, requireAdmin } from '../middleware/auth.js';
import { getPaidNotFinalisedReport } from '../queries/homeQueries.js';
...
router.get('/', async (req, res, next) => {
    try {
        ...
        const ws = wb.addWorksheet('Paid Not Finalised');
        ws.columns = [
        ...
        res.setHeader('Content-Disposition', `attachment; filename="PaidNotFinalised_${program.slug}.xlsx"`);

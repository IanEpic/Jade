(function() {
  ...
  formEmail.addEventListener("submit", function(e) {
    ...
    fetch(CHECK_URL, {
      ...
      if (data.status === "password") {
        ...
        document.getElementById("password-greeting").textContent = "Welcome back" + (data.name ? ", " + data.name : "") + "! Please enter your password.";
  ...
  if (pwEmail) {
    document.getElementById("password-greeting").textContent = "Please enter your password for " + pwEmail + ".";
    show("password");
  }
})();

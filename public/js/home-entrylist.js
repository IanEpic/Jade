(function() {
    ...
    transferForm.addEventListener("submit", function(e) {
      ...
      fetch(transferForm.action, {
        ...
        if (srcRow) {
          ...
          if (srcBadge) {
            srcBadge.textContent = "Unpaid";
            srcBadge.className = "badge badge-unpaid";
          }
        }
        ...
        if (tgtRow) {
          ...
          if (tgtBadge) {
            tgtBadge.textContent = "Entered";
            tgtBadge.className = "badge badge-entered";
          }
        }
        resortTable();
  ...
  document.addEventListener("click", function(e) {
    ...
    origNote.innerHTML = "";
    if (origcatid) {
      origNote.innerHTML = "Original category (questions &amp; responses): " + (origcatname || "ID " + origcatid) + "<br>Current category: " + catname + "<br>Select the original category to revert.";
    } else {
      origNote.innerHTML = "Current category: " + catname + "<br>Select a different category to override (original will be remembered).";
    }
    ...
    if (transferBtn) {
      ...
      transferBtn.textContent = "Transfer Payment";
    }
